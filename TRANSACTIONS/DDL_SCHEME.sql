...
/*ALTER TABLE b_categories MODIFY title VARCHAR2(255);*/
...
CREATE TABLE  b_posts(
 ...
 descr VARCHAR2(1024) NOT NULL,
 status NUMBER(1)DEFAULT 0 NOT NULL ,
 created_at DATE,
 updated_at DATE,
 CONSTRAINT b_posts_pk PRIMARY KEY(post_id),
 CONSTRAINT b_posts_user_fk FOREIGN KEY(user_id) REFERENCES b_users(user_id),
...
/*
ALTER TABLE b_posts MODIFY descr VARCHAR2(1024);
ALTER TABLE b_posts MODIFY title VARCHAR2(255);
*/
...
status NUMBER(1) DEFAULT 0 NOT NULL,
 ...
 CONSTRAINT  b_comments_user_fk FOREIGN KEY(user_id) REFERENCES b_users(user_id),
